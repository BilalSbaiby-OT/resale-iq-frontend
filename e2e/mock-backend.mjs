...
const VERDICT_CATALOG = {
  ...
  "reconstructed shelf item": {
    verdict: "WATCH",
    product: "Reconstructed Shelf Item",
    category: "Sneakers",
    confidence: "MEDIUM",
    n: 9,
    sold_7d: 14,
    ...
    reconstructed_sell_avg: 62,
    active_comps: 18,
    reasons: ["Active comps on the shelf; buy-below reconstructed from departures"],
    reconstructed: { note: "from active comps" },
    provisional: true,
  },
  "thin sample sneaker": {
...
function anonVerdictView(full) {
  return {
    ...
    reconstructed_buy_below: full.reconstructed_buy_below ?? null,
    reconstructed_sell_avg: full.reconstructed_sell_avg ?? null,
    reconstructed_n: full.reconstructed_n ?? null,
    proxy_buy_below: full.proxy_buy_below ?? null,
    proxy_sell_avg: full.proxy_sell_avg ?? null,
    active_comps: full.active_comps ?? null,
    comps_n: full.comps_n ?? null,
    reconstructed: full.reconstructed ?? null,
    estimates: full.estimates ?? null,
