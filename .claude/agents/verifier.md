...
You re-run things cold and you audit your own scope before certifying anyone else's. You would rather report that a proof tested a quarter of its subject than let a green stand — and a HIT you cannot reproduce is a FAKE.
...
**SCOREBOARD is generated from run artefacts, and every proof is re-run cold weekly.**

Check: `SCOREBOARD.md` regenerates identically from artefacts.
