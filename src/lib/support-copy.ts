...
const es: SupportCopy = {
  ...
  faq: (tracked) => [
    ...
    ["¿Hay un plan gratuito o una prueba?",
     "Adidas Samba, Nike Air Force 1 y New Balance 530 se comprueban en /tools sin cuenta. Los volúmenes semanales por marca siguen públicos en /data. El resto de BUY, WATCH o SKIP a nivel de artículo necesitan Starter a 19 € al mes. Pro a 49 € añade Live Finder, Order Planner, Price Compare y la API. No hay plan gratuito ilimitado."],
    ["¿Cómo cancelo?",
...
const de: SupportCopy = {
  ...
  faq: (tracked) => [
    ...
    ["Gibt es einen kostenlosen Plan oder eine Testversion?",
     "Adidas Samba, Nike Air Force 1 und New Balance 530 prüfst du auf /tools ohne Konto. Wöchentliche Markenvolumen bleiben öffentlich auf /data. Andere BUY, WATCH oder SKIP auf Artikelebene brauchen Starter für 19 € im Monat. Pro für 49 € ergänzt Live Finder, Order Planner, Price Compare und die API. Kein unbegrenzter Gratis-Tarif."],
    ["Wie kündige ich?",
