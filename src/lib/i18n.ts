...
export const copy = {
  ...
  fr: {
    ...
    checker: {
      ...
      paywallBody: "{{TRACKED}} annonces analysées. Verdict BUY/WATCH/SKIP + le prix d'achat exact — Starter à 19 €/mois, résiliable à tout moment.",
  ...
  es: {
    ...
    checker: {
      ...
      paywallBody: "{{TRACKED}} anuncios analizados. Veredicto BUY/WATCH/SKIP + el precio de compra exacto — Starter a 19 €/mes, cancela cuando quieras.",
  ...
  de: {
    ...
    checker: {
      ...
      paywallBody: "{{TRACKED}} Angebote analysiert. BUY/WATCH/SKIP-Urteil + der exakte Kaufpreis — Starter ab 19 €/Monat, jederzeit kündbar.",
  ...
  it: {
    ...
    checker: {
      ...
      paywallBody: "{{TRACKED}} annunci analizzati. Verdetto BUY/WATCH/SKIP + il prezzo d'acquisto esatto — Starter a 19 €/mese, disdici quando vuoi.",
  ...
  pt: {
    ...
    checker: {
      ...
      paywallBody: "{{TRACKED}} anúncios analisados. Veredicto BUY/WATCH/SKIP + o preço de compra exato — Starter a 19 €/mês, cancela quando quiseres.",
