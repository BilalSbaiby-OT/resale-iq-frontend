  ...
  en: {
    ...
    pricingSection: {
      ...
      faq: [
        ...
        // Revenue 2026-09-23.
        { q: "Can I trust the numbers, and can I cancel?", a: "If it's not what you expected in the first 30 days, reply to your receipt for a full refund — no questions. Every figure comes from listings we watch across five markets, shown as aggregates you can verify on the public data page. Cancel from Account in one click; access runs to the end of the month you paid for." },
      ],
    },
  ...
  fr: {
    ...
    pricingSection: {
      ...
      faq: [
        ...
        { q: "Puis-je faire confiance aux chiffres, et puis-je résilier ?", a: "Si ce n'est pas ce que vous attendiez dans les 30 premiers jours, répondez à votre reçu pour un remboursement complet — sans question. Chaque chiffre provient d'annonces que nous observons sur les cinq marchés, présentées en agrégats que vous pouvez vérifier sur la page de données publique. Vous résiliez depuis Compte en un clic ; l'accès va jusqu'à la fin du mois payé." },
  ...
  es: {
    ...
    pricingSection: {
      ...
      faq: [
        ...
        // H94 CRO: lead with money-back guarantee. Revenue 2026-09-23.
        { q: "¿Puedo fiarme de los números y puedo cancelar?", a: "Si no es lo que esperabas en los primeros 30 días, responde a tu recibo para un reembolso completo — sin preguntas. Cada cifra proviene de anuncios que observamos en los cinco mercados, mostrados como agregados que puedes comprobar en la página de datos pública. Cancelas desde Cuenta en un clic; el acceso llega hasta el final del mes pagado." },
  ...
  de: {
    ...
    pricingSection: {
      ...
      faq: [
        ...
        // H94 CRO: lead with money-back guarantee. Revenue 2026-09-23.
        { q: "Kann ich den Zahlen trauen, und kann ich kündigen?", a: "Wenn es in den ersten 30 Tagen nicht deinen Erwartungen entspricht, antworte auf deine Quittung für eine vollständige Rückerstattung — ohne Fragen. Jede Zahl stammt aus Angeboten, die wir auf den fünf Märkten beobachten, als Aggregate dargestellt, die du selbst auf der öffentlichen Datenseite prüfen kannst. Du kündigst im Konto mit einem Klick; der Zugang läuft bis zum Ende des bezahlten Monats." },
  ...
  it: {
    ...
    pricingSection: {
      ...
      faq: [
        ...
        // H94 CRO: lead with money-back guarantee. Revenue 2026-09-23.
        { q: "Posso fidarmi dei numeri e posso disdire?", a: "Se non è ciò che ti aspettavi entro i primi 30 giorni, rispondi alla tua ricevuta per un rimborso completo — senza domande. Ogni cifra proviene da annunci che osserviamo sui cinque mercati, mostrati come aggregati che puoi verificare sulla pagina dati pubblica. Disdici da Account con un clic; l'accesso arriva alla fine del mese pagato." },
  ...
  pt: {
    ...
    pricingSection: {
      ...
      faq: [
        ...
        // H94 CRO: lead with money-back guarantee. Revenue 2026-09-23.
        { q: "Posso confiar nos números e posso cancelar?", a: "Se não for o que esperavas nos primeiros 30 dias, responde ao teu recibo para um reembolso completo — sem perguntas. Cada valor vem de anúncios que observamos nos cinco mercados, apresentados como agregados que podes verificar na página de dados pública. Cancelas em Conta com um clique; o acesso vai até ao fim do mês pago." },
