  ...
  en: {
    ...
    auth: {
      ...
      register: {
        ...
        paidNote: "Secure Stripe checkout opens next — cancel anytime.",
  ...
  fr: {
    ...
    auth: {
      ...
      register: {
        ...
        paidNote: "Stripe Checkout sécurisé s'ouvre ensuite — résiliable à tout moment.",
  ...
  es: {
    ...
    auth: {
      ...
      register: {
        ...
        paidNote: "Se abre el pago seguro de Stripe — cancela en cualquier momento.",
  ...
  de: {
    ...
    auth: {
      ...
      register: {
        ...
        paidNote: "Sicherer Stripe-Checkout öffnet als Nächstes — jederzeit kündbar.",
  ...
  it: {
    ...
    auth: {
      ...
      register: {
        ...
        paidNote: "Si apre il checkout Stripe sicuro — annullabile in qualsiasi momento.",
  ...
  pt: {
    ...
    auth: {
      ...
      register: {
        ...
        paidNote: "Abre o checkout Stripe seguro a seguir — cancela quando quiseres.",
