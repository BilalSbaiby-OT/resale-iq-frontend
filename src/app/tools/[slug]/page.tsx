      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        <div style={{ marginTop: 30, padding: "22px 24px", background: "#0f1720", border: "1px solid #1c3327", borderRadius: 12, textAlign: "center" }}>
          ...
          <p style={{ fontSize: 13.5, color: "#8b99b8", margin: "8px 0 16px" }}>
            Buy-below price, sell price and best sizes on every item (sell-through rolling out as sold-date history matures) — from {tracked} unique Vinted listings across 5 EU markets.
          </p>
