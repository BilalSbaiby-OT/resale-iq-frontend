...
const faq = (tracked: string): [string, string][] => [
  ...
  ["Is there a free plan or trial?",
   "Yes. Free is 7 days unlimited, then 10 full checks a month. Every check shows the numbers — buy-below price, sale price and size velocity. No card required; you just verify your email. Paid plans remove the monthly cap."],
  ["How do I cancel?",
