...
const faq = (tracked: string): [string, string][] => [
  ...
  ["What's the difference between Starter and Pro?",
   "Starter (€19/mo) gives you unlimited verdicts, all 100 product signals, market trends, brand rankings, the authenticity checker, and watchlist + portfolio P&L. Pro (€49/mo) adds the live deal finder across 5 markets, the 3-week Order Planner, per-size velocity, and REST API access."],
  ["Is there a free plan or trial?",
   "Yes. Free gives you 3 verdicts a day, plus 10 full unlocks that show every number — buy-below price, sale price and size velocity. The 10 are for the life of the account, not per month: they do not refill. No card required; you just verify your email. Paid plans remove the daily limit."],
  ["How do I cancel?",
