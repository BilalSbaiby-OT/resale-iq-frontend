    ...
    <div style={{ background: "#0B0D10", color: "#c3cde0", minHeight: "100vh", padding: "48px 24px" }}>
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        {[
          ...
          ["Third parties", "We use Stripe (payments), an email provider for transactional email, and hosting infrastructure. Each processes data only to deliver its function."],
