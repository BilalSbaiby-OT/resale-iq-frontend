...
export const POSTS_95: BlogPost[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Tommy Hilfiger jackets: 129 brand-level departures in the last 30 days at €36.10 average on EU Vinted (September 2026). Ralph Lauren: 1,027 brand-level departures across all categories at €37.21 average — jacket-specific figures not separately published. Tommy Hilfiger has higher jacket-category volume and wider charity-shop supply frequency in Europe; Ralph Lauren commands higher average exit prices across all categories. The Tommy Jeans Sherpa Trucker (€65–80) is the standout TH piece; RL Polo Sport and Bear jackets are the equivalent premium. Both brands suit a combined American heritage outerwear sourcing lane — TH for jacket volume, RL for overall per-unit premium when found.",
      },
    ],
  },
]
