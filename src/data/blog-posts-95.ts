...
// DISTINCT from tommy-hilfiger-hoodie-eu-vinted-price-guide (hoodies only: 40/7d @€18,
// buy-below €11.70, Tommy Jeans sub-brand distinction) and
// tommy-hilfiger-reselling-vinted-guide (brand overview: all categories).
// This guide is Jackets-only: 10/7d @€47 avg, buy-below €30.55, Tommy Jeans Sherpa
