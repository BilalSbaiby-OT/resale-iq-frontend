...
export const POSTS_58: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "New Balance tracks eight models in the EU Vinted dataset with sufficient departure data. The model hierarchy by volume is: 530 (104/7d at €37.47, DEAD), 9060 (49/7d at €78.83, FADING), 740 (12/7d at €34.84, STABLE), 2002R (7/7d at €45.18, STABLE), 550 (6/7d at €40.97, STABLE), 574 (5/7d at €30.20, FADING), 1906R (4/7d at €56.35, FADING), and 327 (4/7d at €32.68, FADING). The 530 and 9060 account for approximately 77% of total NB brand weekly departure volume, with the 530 at 52% and the 9060 at 25%.",
      ...
      },
      {
        ...
        p: [
          "The EU Vinted mid-range and accessible premium sneaker segment includes the NB 530 (104/7d at €37.47, DEAD), Nike Air Force 1 (33/7d at €99.09, STABLE), Adidas Stan Smith (7/7d at €84.14, RISING), and Adidas Samba (6/7d at €48.01, DEAD). The comparison is directly relevant for EU resellers choosing where to allocate sourcing time in Q4 2026. The NB 530 has the highest departure volume in this group by a wide margin — but the lowest per-unit exit and the most negative momentum signal.",
          "Nike Air Force 1 generates 33 departures per week at €99.09 average — one-third the volume of the 530 but 2.6× the per-unit exit. Buy-below ceiling for the AF1 is €65.89. STABLE momentum signal means the AF1 has held its trend position without the decline the 530 has experienced. For resellers with access to AF1 pairs below €65.89 — primarily through charity shops in France (where Jordan brand and Nike are heavily donated) or EU Vinted arbitrage — the AF1 delivers significantly better margin per item than the 530 at lower departure volume. The trade-off is sourcing difficulty: AF1 sourcing below €65.89 is less reliable than 530 sourcing below €24.92.",
          `Adidas Samba's DEAD momentum (matching the 530) at 6/7d and €48.01 reveals an important pattern: both models reached trend saturation in 2025 and are now declining. The Samba's DEAD rating arrived despite its sustained press coverage in EU fashion media — a reminder that press momentum and Vinted departure velocity are uncorrelated when the buyer pool that drove the trend has already purchased. Adidas Stan Smith (RISING, 7/7d at €84.14) is the positive outlier — rising momentum at a higher per-unit exit, suggesting a model entering rather than exiting its trend cycle. For EU sourcing decisions in Q4 2026: 530 remains viable for volume at tight margins; AF1 and Stan Smith are higher-priority models where sourcing price allows. [Compare all sneaker models →](${ilinkHref("data")})`,
        ],
      },
      {
