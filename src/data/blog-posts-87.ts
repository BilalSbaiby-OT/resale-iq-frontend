...
export const POSTS_87: BlogPost[] = [
  {
    ...
    description:
      "Lacoste shirts track 57 watched departures per week across EU Vinted in September 2026 at a €29 average exit price — the single largest category in the Lacoste EU Vinted dataset. Real exit ranges by shirt type, buy-below ceiling €18.85, condition grading, and how Lacoste shirts compare to Fred Perry and Ralph Lauren for EU resellers.",
    date: "2026-09-16",
    category: "Sourcing",
    readMins: 7,
    ...
    intro:
      "Lacoste shirts track 57 watched departures per week across EU Vinted in the week to 16 September 2026 at a €29 average exit price — the single largest category in the Lacoste EU Vinted dataset, ahead of Lacoste T-shirts (15/7d at €19), Lacoste hoodies (9/7d at €49), and Lacoste jackets (7/7d at €99). The entire Lacoste brand tracks 101 watched departures per week at a €34 brand average across five categories. At a buy-below ceiling of €18.85 (€29 × 0.65), the Lacoste shirt category delivers a gross margin of approximately €10.15 per shirt on a correctly sourced unit — modest in absolute terms, but sustainable at volume given the category's 57-unit weekly throughput. This guide covers exit prices by shirt type, the buy-below ceiling, condition grading that separates €20 exits from €40 exits, how Lacoste shirts differ from Lacoste polos as a reseller category, and how the category stacks against Fred Perry shirts (335/7d at €14) and Ralph Lauren shirts for EU Vinted sourcing decisions.",

    definedTerm: {
      name: "Lacoste shirt departure average",
      description:
        "The Lacoste shirt departure average is the average price at which a tracked Lacoste shirt listing leaves the shelf on EU Vinted — not the asking price and not the retail price. As of the week to 16 September 2026, Lacoste shirts track 57 watched departures per week across France, Germany, Spain, Italy, and Portugal at a €29 average exit price. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The broader Lacoste brand tracks 101 watched departures per week at a €34 brand average across all categories. The buy-below ceiling for the shirt category at the €29 exit average is €18.85 — that is €29 × 0.65, targeting a 35% gross margin after platform fees. Lacoste shirts are the highest-volume category in the Lacoste EU Vinted dataset, representing 56% of all tracked Lacoste watched departures per week in September 2026.",
    },
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "At a €29 average exit price, the buy-below ceiling is €18.85 (€29 × 0.65). This targets a 35% gross margin before Vinted platform fees, typically 5–8% of transaction value on the buyer side. Net of a 6% platform assumption, the actual take on a €29 exit is approximately €27.26, giving a €8.41 net margin on a €18.85 buy — a 44.6% net ROI on capital deployed per shirt, weak in absolute euros but structural at 57-unit weekly throughput.",
      ...
      },
      {
        ...
        p: [
          "The polo guide covers Lacoste's piqué cotton polo — the L.12.12 sport-heritage silhouette, different fabric, different buyer psychology. Shirts and polos are not interchangeable in a sourcing strategy. By volume, shirts lead at 57 watched departures/7d. By buyer intent, polo buyers source brand recognition; shirt buyers source wearability — a shirt that works for smart-casual European use. The shirt buyer is slightly older, less streetwear-oriented, and more likely to pay a condition premium.",
