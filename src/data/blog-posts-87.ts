...
export const POSTS_87: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "The polo guide covers Lacoste's piqué cotton polo — the L.12.12 sport-heritage silhouette, different fabric, different buyer psychology. Shirts and polos are not interchangeable in a sourcing strategy. By volume, shirts lead at 199 departures in the last 30 days. By buyer intent, polo buyers source brand recognition; shirt buyers source wearability — a shirt that works for smart-casual European use. The shirt buyer is slightly older, less streetwear-oriented, and more likely to pay a condition premium.",
    ...
    faq: [
      {
        ...
        a: "Lacoste shirts track 57 departures in the last 30 days (observation window to 22 September 2026) across EU Vinted at a €29 average exit price. 'Watched departure' means a tracked Lacoste shirt listing left the shelf — not a confirmed buyer-reported sale. The shirt category represents 56% of all Lacoste watched departures per week in September 2026, making shirts the single largest category in the Lacoste EU Vinted dataset ahead of T-shirts (15 departures in the last 30 days), hoodies (9 departures in the last 30 days), jackets (7 departures in the last 30 days), and bags (4 departures in the last 30 days). The broader Lacoste brand tracks 101 departures in the last 30 days at a €34 brand average across all five categories. Weekly counts reflect EU markets including France, Germany, Spain, Italy, and Portugal.",
      },
      {
