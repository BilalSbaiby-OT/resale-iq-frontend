...
// using September 14 data) — this guide is Sneakers-only: 5 departures in the last 30 days @€154 avg
...
export const POSTS_96: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "The three highest average-exit sneaker categories tracked in the EU Vinted dataset (as of September 2026) are Gucci Sneakers (€212 avg, 37 departures in the last 30 days), Off-White Sneakers (€154 avg, 5 departures in the last 30 days), and Balenciaga (€153 brand avg across all categories, ~30 departures in the last 30 days). Each has a distinct sourcing profile. Gucci sneakers have the highest absolute exit price and the highest volume of the three, but also the highest sourcing floor — Gucci shoes at EU charity shops are increasingly priced at €30–80 as thrift shops recognise the brand, compressing margins. Gucci's buy-below ceiling is €137.80 (€212 × 0.65), achievable but harder to hit as sourcing floors rise.",
