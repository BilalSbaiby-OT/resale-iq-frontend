    ...
    sections: [
      {
        ...
        p: [
          "Stone Island tracks 178 departures in the last 30 days across all categories on EU Vinted at a €70 brand average — making it the third-highest-volume brand in the ResaleIQ EU database behind Fred Perry (199 departures in the last 30 days) and Patagonia (178 departures in the last 30 days). But unlike those brands, Stone Island's volume is concentrated: hoodies account for 395 of the 727 departures in the last 30 days (54%), jackets for 168 (23%), shirts for 74 (10%), and T-shirts for 57 (8%). Caps contribute just 11 per week.",
