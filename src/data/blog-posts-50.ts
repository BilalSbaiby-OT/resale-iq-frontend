...
export const POSTS_50: BlogPost[] = [
  {
    ...
    intro:
      "Patagonia jackets track 780 departures in the last 30 days (observation window to 22 September 2026) across EU Vinted at a €51 average exit price — the largest jacket departure volume of any brand tracked on the platform. Patagonia jackets represent the single most liquid jacket category in the EU secondhand market: more 30-day departures than The North Face jackets (108 departures in the last 30 days at €48), Arc'teryx (which is lower volume at higher per-unit price), and Moncler (which trades at higher price but far fewer departures). The buy-below ceiling of €33.15 (€51 × 0.65) is reliably achievable at EU charity shops and clearance markets, making Patagonia the highest-volume, lowest-friction jacket category available to EU resellers in 2026. This guide covers exit prices by model, buy-below ceilings by category, condition grading checkpoints, and how Patagonia compares to The North Face for EU reselling strategy.",
    definedTerm: {
    ...
    sections: [
      {
        h: "Patagonia jackets on EU Vinted: 780 departures in the last 30 days at €51 average",
        p: [
          "Patagonia jackets are the highest-volume jacket category tracked on EU Vinted by weekly departure count. At 780 departures in the last 30 days in September 2026 at a €51 average exit price, the category delivers consistent, predictable liquidity across all five EU markets we track (France, Germany, Spain, Italy, Portugal). For context: Patagonia jackets represent 42% of the brand's total 733 departures in the last 30 days — the jacket category is the dominant driver, with hoodies (780 departures in the last 30 days at €40 avg), bags (202 departures in the last 30 days at €24 avg), caps (68 departures in the last 30 days at €9 avg), and T-shirts (58 departures in the last 30 days at €17 avg) filling out the rest of the brand's EU Vinted footprint.",
      ...
      },
      {
        ...
        p: [
          ...
          "The Patagonia brand's 1323 total 30-day departures across all categories — with jackets (780), hoodies (165), bags (165), caps (68), and T-shirts (58) — means a reseller working the Patagonia category has multiple complementary product lines. A charity shop visit producing three Synchilla fleeces and a Patagonia tote bag is a viable sourcing session: the bag (€24 avg exit at 202 departures in the last 30 days category volume) is a different buyer profile but the same sourcing location. The brand's breadth gives it the highest EU Vinted vol×val score of any outdoor brand we track.",
        ],
      },
    ],
    faq: [
