    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          "Fred Perry is one of the few brands where volume sourcing is viable at entry reselling scale. The €9.10 buy-below ceiling is reachable — Fred Perry polos appear frequently at UK charity shops (£3–6 tier), French vide-greniers (€2–5), and German Kleiderkreisel lots. The combination of high weekly departure volume (403/7d) and accessible sourcing prices means a reseller can build a Fred Perry polo pipeline with lower capital commitment than most other tracked brands.",
