...
export const POSTS_37: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Fred Perry vs Lacoste: Lacoste tracks 2,220 brand-level departures in the last 30 days at a €27.24 average — below Fred Perry's 10,425 brand-level departures/30d at €21.32 average on volume but at more than double the average exit price. Lacoste polos exit at €25–45 for clean pieces in core colours; Fred Perry exits at €12–20. For a reseller with a lower capital budget, Fred Perry has better volume and lower sourcing costs; for a reseller focused on per-item margin, Lacoste's higher exit price justifies the higher buy price.",
