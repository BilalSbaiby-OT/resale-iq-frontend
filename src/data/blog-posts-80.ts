...
export const POSTS_80: BlogPost[] = [
  {
    ...
    intro:
      "Stone Island Jackets track 51 departures in the last 30 days across EU Vinted — France, Germany, Spain, Italy, and Portugal — in the week to 15 September 2026, at a €140 average exit price. At €140, Stone Island Jackets are the highest-value outerwear category in the ResaleIQ tracked EU Vinted dataset: they outscore Patagonia Jackets (~€51), The North Face Jackets (€47), Carhartt Jackets (€53), and Diesel Jackets (€64) on per-departure exit value by a factor of 2 to 3. The 51 departures in the last 30 days departure frequency places Stone Island Jackets second only to Stone Island Hoodies (178 departures in the last 30 days @€56) within the brand — but at €140 average, each Jacket departure generates 2.5× the revenue of a Hoodie departure. The buy-below ceiling at a 35% gross margin target is €86.45. Stone Island Jackets are the per-unit revenue leader in the Stone Island cluster and the highest-scoring category in the EU Vinted tracked outerwear market for September 2026.",
    definedTerm: {
      name: "Stone Island Jackets departure average",
      description:
        "The Stone Island Jackets departure average is the average price at which a tracked Stone Island Jacket listing leaves the shelf on EU Vinted — not the asking price and not the retail price. As of the week to 15 September 2026, Stone Island Jackets track 51 departures in the last 30 days across France, Germany, Spain, Italy, and Portugal at a €140 average exit price. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The buy-below ceiling is €86.45, targeting a 35% gross margin after Vinted's approximately 5% seller protection fee. The Stone Island brand overall tracks 178 departures in the last 30 days at a €71 brand-wide average. Jackets represent 24% of Stone Island departure volume but the highest per-departure revenue of any Stone Island category. The Compass badge (Stone Island's signature arm badge) is the primary authenticity marker and the main driver of price discovery across all Jacket categories. Stone Island Jackets are the highest-value outerwear category in the September 2026 ResaleIQ EU Vinted tracked dataset.",
    },
    sections: [
      {
        h: "Stone Island Jackets on EU Vinted: 51 departures in the last 30 days, the highest-value tracked outerwear category",
        p: [
          "Stone Island Jackets track 51 departures in the last 30 days (observation window to 22 September 2026) across EU Vinted, at a €140 average exit price — the highest average of any outerwear brand-category combination in the ResaleIQ tracked dataset. The outerwear market comparison on EU Vinted is direct: The North Face Jackets (88 departures in the last 30 days @€47), Diesel Jackets (16 departures in the last 30 days @€64), Carhartt Jackets (21 departures in the last 30 days @€53), Patagonia Jackets (traceable in the dataset). Stone Island Jackets at 51 departures in the last 30 days @€140 lead both departure volume and per-unit value among tracked premium outerwear categories — no other tracked jacket category matches both figures simultaneously.",
          "Within the Stone Island cluster itself, Jackets occupy the per-unit revenue position that Hoodies occupy in volume. Stone Island Hoodies track 178 departures in the last 30 days @€56 — 2.2× the departure frequency of Jackets but at 40% of the per-departure value. A single Stone Island Jacket departure at €140 generates the same gross receipt as 2.5 Stone Island Hoodie departures at €56. For a reseller managing capital allocation across the Stone Island range, the Jacket tier is the highest-value unit in the portfolio: it requires more targeted sourcing but returns more per acquisition than any other Stone Island category.",
          `The 51 departures in the last 30 days departure frequency is not explained by low barriers to purchase: at €140 average, EU Vinted buyers for Stone Island Jackets are informed buyers making deliberate decisions about a premium purchase. The departure rate reflects genuine demand — EU Vinted is the primary secondary market for Stone Island outerwear in France, Germany, Spain, Italy, and Portugal, and 51 departures in the last 30 days means the EU Vinted market absorbs 2.3 Stone Island Jackets per day from tracked inventory. [Stone Island brand data →](${ilinkHref("flip")})`,
        ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Stone Island Jackets track 51 departures in the last 30 days across EU Vinted — France, Germany, Spain, Italy, and Portugal — in the week to 15 September 2026. 'Watched departures' means tracked listings that left the shelf, not confirmed buyer-reported sales. Stone Island Jackets are the highest-value outerwear category in the ResaleIQ September 2026 EU Vinted tracked dataset, leading The North Face Jackets (88 departures in the last 30 days @€47), Diesel Jackets (16 departures in the last 30 days @€64), and Carhartt Jackets (21 departures in the last 30 days @€53) on per-departure exit value. Within the Stone Island brand, Jackets are second only to Hoodies (178 departures in the last 30 days) by departure volume.",
      },
      {
