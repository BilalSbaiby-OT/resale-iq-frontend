...
// This guide is hoodie-only: live 40/7d volume at €18 avg, Tommy Jeans hoodie-specific
// premium (€30–50 exit vs €14–22 mainline), condition tiers, model-level breakdown,
// and the volume-vs-price trade-off vs Ralph Lauren hoodies (20/7d at €46).
...
export const POSTS_92: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Ralph Lauren hoodies and Tommy Hilfiger hoodies are the two dominant mid-range hoodie brands on EU Vinted in September 2026, but they serve different reseller strategies. Tommy Hilfiger delivers 2× the weekly transaction volume (40/7d vs 20/7d for Ralph Lauren) at less than half the average exit price (€18 vs €46). Ralph Lauren is the better-margin category per unit; Tommy Hilfiger is the better-volume category for resellers who can source consistently at below €9 per mainline piece.",
          "The practical implication: a Tommy Hilfiger hoodie operation at €8 average sourcing and €18 exit produces €5.22 net margin per unit — at 40 departures per week that is €208.80 weekly net margin from the category if you can capture proportional share. A Ralph Lauren hoodie operation at €19 average sourcing and €46 exit produces €13.34 net margin per unit — at 20 departures that is €266.80 weekly net margin at full participation. Ralph Lauren wins on margin per unit; Tommy Hilfiger wins on available sourcing volume. The reseller decision depends on local sourcing access — charity shop density and regional stock differ across EU markets.",
          `Lacoste hoodies track 9 watched departures per week at €49 average on EU Vinted — low volume relative to both Tommy Hilfiger and Ralph Lauren. For a reseller choosing between old-money hoodie categories by weekly opportunity, the ranking is: Tommy Hilfiger (40/7d, highest volume, lowest per-unit), Ralph Lauren (20/7d, highest per-unit margin, mid-volume), Lacoste (9/7d, lowest volume but highest average after Ralph Lauren at €49). Tommy Jeans hoodies (a subset of the Tommy Hilfiger 40/7d count) narrow the per-unit margin gap to Ralph Lauren significantly — Tommy Jeans exits at €30–€50 make it competitive with RL on gross margin when correctly sourced below €16. [Check live Tommy Hilfiger data →](${ilinkHref("flip")})`,
        ],
    ...
    faq: [
      {
        ...
        a: "Tommy Hilfiger hoodies track 40 watched departures per week across EU Vinted in the week to 16 September 2026 at an €18 average exit price. 'Watched departure' means a tracked Tommy Hilfiger hoodie listing left the shelf — not a confirmed buyer-reported sale. The hoodie category represents 67% of all Tommy Hilfiger watched departures per week in September 2026, making it the highest-volume single category in the brand's EU Vinted dataset. The broader Tommy Hilfiger brand tracks 60 watched departures per week at a €23 brand average across five categories: hoodies (40/7d at €18), jackets (10/7d at €47), jeans (4/7d at €26), T-shirts (4/7d at €14), and shirts (2/7d at €9). Weekly counts cover EU markets including France, Germany, Spain, Italy, and Portugal. ResaleIQ updates these counts weekly from the EU Vinted market dataset.",
      },
      {
