...
export const POSTS_92: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Ralph Lauren hoodies and Tommy Hilfiger hoodies are the two dominant mid-range hoodie brands on EU Vinted in September 2026, but they serve different reseller strategies. Tommy Hilfiger delivers 2× the weekly transaction volume (40 departures in the last 30 days vs 20 departures in the last 30 days for Ralph Lauren) at less than half the average exit price (€18 vs €46). Ralph Lauren is the better-margin category per unit; Tommy Hilfiger is the better-volume category for resellers who can source consistently at below €9 per mainline piece.",
