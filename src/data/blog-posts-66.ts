...
export const POSTS_66: BlogPost[] = [
  {
    ...
    sections: [

      {
        ...
        p: [
          ...
          `Stone Island's total brand volume is dominated by hoodies at 178 departures in the last 30 days (€56) — followed by jackets (40 departures in the last 30 days at €143), shirts (10 departures in the last 30 days at €12), T-shirts (9 departures in the last 30 days at €26), and caps (2 departures in the last 30 days at €20). Hoodies are the brand's most liquid category by a significant margin. [Stone Island full brand data →](${ilinkHref("flip")})`,
        ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Stone Island hoodies track 178 departures in the last 30 days across EU Vinted (France, Germany, Spain, Italy, Portugal) in the week to 19 September 2026 — the highest-volume branded hoodie category tracked by ResaleIQ on a per-unit exit price basis. 'Watched departures' means tracked listings that left the shelf, not confirmed buyer-reported sales. Hoodies are the dominant category in the Stone Island EU Vinted dataset.",
      },
      {
