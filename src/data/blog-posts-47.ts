...
export const POSTS_47: BlogPost[] = [
  {
    ...
    intro:
      "Adidas sneakers track 45 departures in the last 30 days (observation window to 22 September 2026) across EU Vinted at a €60 average exit price — the single highest-volume trainer category in our EU dataset, ahead of Nike Air Force 1 (38 departures in the last 30 days, €52 avg) and Jordan 3 (29 departures in the last 30 days, €97 avg). The Adidas Gazelle and Gazelle Indoor are among the most searched Adidas models on EU Vinted, driven by the shoe's sustained cultural relevance since Beyoncé's 2023 Renaissance tour appearances. Our live data shows the Gazelle Indoor category tracking 4 departures in the last 30 days at €58 average with RISING momentum — low volume, fast clearance. For EU resellers, the real volume opportunity sits in the Handball Spezial (12 departures in the last 30 days at €79) and the Samba family, while the Gazelle Indoor represents a precision play: fewer units, better margin per transaction. This guide covers exit prices by model, buy-below ceilings by size, momentum signals, and sourcing method across the five EU Vinted markets.",
    definedTerm: {
      name: "Adidas Gazelle departure average",
      description:
        "The Adidas Gazelle departure average is the average price at which a tracked Adidas Gazelle listing leaves the shelf on EU Vinted — not the asking price and not the retail price. The Adidas Gazelle Indoor variant tracks 4 departures in the last 30 days in the week to 15 September 2026 across France, Germany, Spain, Italy, and Portugal at a €58 average exit price. The broader Adidas sneaker category tracks 45 departures in the last 30 days at a €60 average across all Adidas trainer models. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The Adidas brand overall tracks 85 departures in the last 30 days at a €53 average across all categories. The buy-below ceiling for the Gazelle Indoor at the €58 exit average is €37.70 — targeting a 35% gross margin after platform fees.",
    },
    sections: [
      {
        h: "Adidas sneakers on EU Vinted: 45 departures in the last 30 days at €60 average",
        p: [
      ...
      },
      {
        ...
        p: [
          "The Adidas Gazelle Indoor is the Gazelle variant with strongest current momentum on EU Vinted. At 4 departures in the last 30 days at a €58 average, it is a precision category: fewer 30-day transactions but a RISING momentum signal and a 80 speed score — both indicate the model clears faster than its volume suggests. The buy-below ceiling at the €58 exit average is €37.70 (€58 × 0.65). For size 36 specifically — the dominant size in our dataset — the ceiling tightens to €33.25 at a €50 average, reflecting size-specific demand concentration.",
          "The Handball Spezial is the highest-volume and highest-per-unit Adidas sneaker in our dataset. At 12 departures in the last 30 days (64 over 30 days) at a €79.38 average, it generates more total gross margin per sourcing session than any other Adidas sneaker model we track. STABLE momentum and a speed score of 37.5 indicate consistent demand without the DEAD signal risk of the Samba. The buy-below ceiling is €52.79 for size 39 (the top-selling size at 17% of 30-day volume) and €52.09 for size 38 (16.7% of volume). These are size-specific ceilings — sourcing a size 37 without a specific data point carries greater price risk.",
          `The Samba is the highest-awareness Adidas model on EU Vinted — 27,338 active listings and 130 watched departures over 30 days — but carries a DEAD momentum signal and a speed score of just 9.2 out of 100. The market is saturated: months of supply sits at 210 (more than 17 years of inventory at current departure rate). A Samba in good condition exits at the €48 average, but it competes against 27,000 other listings. Buy-below for the Samba is €31.93 at brand-category level; size 38 ceiling is €36.58 (€55 avg, n=10). The Stan Smith tracks 7 departures in the last 30 days at €84.14 average with RISING momentum — a smaller but more favourable supply picture (3,619 active listings) and a buy-below of approximately €54.70 at category level. [See all model data →](${ilinkHref("flip")})`,
        ],
    ...
    faq: [
      {
        ...
        a: "The Adidas Gazelle Indoor tracks 4 departures in the last 30 days at a €58 average exit price across EU Vinted in September 2026, with RISING momentum. The broader Adidas sneaker category tracks 45 departures in the last 30 days at a €60 average. Individual exit prices range from €35–45 for worn or smaller sizes to €75–90 for near-new Gazelle Indoor pairs in popular sizes.",
      },
      {
      ...
      },
      {
        ...
        a: "The Stan Smith leads on average exit price at €84 with RISING momentum (7 departures in the last 30 days). The Handball Spezial combines the highest volume (12 departures in the last 30 days) with a strong €79 average — making it the highest total gross margin opportunity. The Samba has the most activity (130 departures/month) but DEAD momentum and a lower €48 average due to market saturation.",
      },
      {
        q: "Is the Adidas Samba still worth reselling on EU Vinted?",
        a: "The Samba carries DEAD momentum in our September 2026 data, with 27,338 active listings competing for 6 departures in the last 30 days — an estimated 210 months of supply. It can still exit profitably at the €48 average if sourced below €32, but clearance time is unpredictable. We recommend the Handball Spezial or Gazelle Indoor over the Samba for consistent throughput.",
      },
      {
        q: "What is the best Adidas sneaker to resell on EU Vinted?",
        a: "By total gross margin per sourcing session: the Handball Spezial (12 departures in the last 30 days, €79 avg, buy-below €52.79, STABLE). By margin efficiency per unit: the Stan Smith (7 departures in the last 30 days, €84 avg, RISING momentum, lower inventory competition). The Gazelle Indoor is a precision play: low weekly volume but fast clearance and RISING signal, best for opportunistic sourcing when a pair appears at charity shop prices.",
      },
      {
