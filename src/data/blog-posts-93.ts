...
// This guide is Nano-only: 5 departures in the last 30 days @€38.20 avg, buy-below €24.83, generation breakdown
    ...
    faq: [
      {
        ...
        a: "Reebok Nano training shoes track 5 departures in the last 30 days (observation window to 22 September 2026) across EU Vinted at a €38.20 average exit price. 'Watched departure' means a tracked Nano listing left the shelf — not a confirmed buyer-reported sale. Current-generation Nano X3 exits at €40–55 in very good condition. Nano X2 (2022) exits at €35–50. Nano X (2021) exits at €30–45. Older generations (Nano 9.0, 8.0) exit at €20–35 depending on condition. The €38.20 average is 2.4× the Reebok brand average of €16 because Nano buyers are CrossFit and functional fitness consumers who purchase for training use, not fashion — a separate buyer pool from fashion Reebok buyers who search for Classic Leather and Club C. ResaleIQ updates Nano departure averages weekly from the EU Vinted market dataset.",
      },
      {
