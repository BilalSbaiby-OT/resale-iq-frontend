...
// DISTINCT from off-white-sneakers-eu-vinted-price-guide (sneakers only, 5/7d @€154,
...
// This guide is HOODIES ONLY: 4/7d @€42 avg (19 Sep 2026 live snapshot),
...
// vs Balenciaga hoodies (38/7d @€100) and Stone Island hoodies (76/7d @€55).
...
export const POSTS_107: BlogPost[] = [
  {
    ...
    intro:
      "Off-White hoodies track 4 watched departures per week across EU Vinted in the week to 19 September 2026 at a €42 average exit price. Hoodies are half of Off-White's 8 weekly brand departures and the second-highest-volume Off-White category behind sneakers (1/7d at €40 in this snapshot — the brand's sneaker page covers a different €154 average across tracked sneaker models). They are 50% of the brand's tracked weekly volume this week. The buyer is not purchasing a Nike collab shoe. They are purchasing a branded fleece layer: a WIP Hooded Chase with the large chest script, a Back to Black hoodie with the diagonal Arrow print, or a basic Off-White pullover with the per-forced label. The buy-below ceiling at €42 average is €27.30 (€42 × 0.65), targeting 35% gross margin after Vinted platform fees. This guide covers the live margin case, Off-White hoodie identification hierarchy, buy-below by condition, and how Off-White hoodies sit against Balenciaga and Stone Island for EU resellers.",

    definedTerm: {
      name: "Off-White hoodie departure average",
      description:
        "The Off-White hoodie departure average is the average price at which a tracked Off-White hoodie listing leaves the shelf on EU Vinted — not the asking price and not retail. As of the week to 19 September 2026, Off-White hoodies track 4 watched departures per week across France, Germany, Spain, Italy, and Portugal at a €42 average exit price. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The broader Off-White brand tracks 8 watched departures per week at a €33 brand average; hoodies exit above the brand average, which T-shirts (2/7d at €26) and shirts (1/7d at €5) pull down. The buy-below ceiling at the €42 departure average is €27.30 (€42 × 0.65), targeting 35% gross margin after Vinted platform fees. ResaleIQ updates Off-White hoodie exit data weekly from EU Vinted departure observations across five markets.",
    },

    sections: [
      {
        h: "Off-White hoodies on EU Vinted: 4 watched departures per week at €42 average",
        p: [
          "Off-White hoodies track 4 watched departures per week across EU Vinted at a €42 average exit price in the week to 19 September 2026. That is the highest-volume Off-White apparel category this week: T-shirts 2/7d at €26, shirts 1/7d at €5. Sneakers, the brand's headline category, tracked 1/7d at €40 in this snapshot — the Off-White sneakers guide covers a different €154 average across broader tracked sneaker models. The €42 hoodie average sits €9 above the €33 brand average because hoodies carry the brand's streetwear premium; T-shirts and shirts drag the brand number down.",
          "4 departures per week at €42 average is €168 of observed weekly hoodie revenue across five markets. That is not a volume operation and it is not the Off-White money — the sneaker category is. Observed T-shirt revenue this week is €52 (2 × €26). The hoodie is the piece that shows up on the same German, French, and Italian charity-shop rails as Stone Island and Balenciaga fleece, and it competes directly with both. Treat the hoodie figure as its own market. An Off-White hoodie buyer on EU Vinted is buying branded streetwear fleece, not a Nike collab, and they will not pay sneaker money for it.",
          `€42 puts Off-White hoodies below Balenciaga hoodies (38/7d at €100) and Stone Island hoodies (76/7d at €55) on exit, and well below both on frequency. Balenciaga and Stone Island are the higher-tier hoodie plays on EU Vinted by both volume and exit. Off-White's hoodie slot is the mid-tier streetwear-fleece position: higher exit than the average hoodie brand, lower frequency than the heritage sportswear names. [Full Off-White brand data →](${ilinkHref("flip")})`,
        ],
      ...
      },
      {
        ...
        p: [
          "Yes, with a WIP or Arrow check and a sourcing price under €20. At 4 watched departures per week and a €42 average, Off-White hoodies are not a primary play. They are the mid-tier streetwear fleece that shows up next to Stone Island and Balenciaga on the same racks. A clean Hooded Chase at €10–15 is one of the better per-minute decisions on a German or French rail. A pilled basic at €18 is a skip.",
          ...
          "In a session that has both a clean Off-White hoodie and a clean Stone Island hoodie, take the Stone Island. Stone Island hoodies exit at €55 average (76/7d) against Off-White at €42 (4/7d) — higher exit and 19× the volume. Off-White becomes the buy when the Stone Island rail is empty or the Off-White piece is a Hooded Chase clearly under €15. Do not confuse either with Off-White sneakers. An Off-White hoodie and an Off-White Nike collab sneaker do not share a buyer, a capital ticket, or an exit band — the sneaker guide covers that separately.",
        ],
      ...
      },
      {
        ...
        p: [
          "Off-White hoodies (4/7d at €42) sit below Balenciaga hoodies (38/7d at €100) and Stone Island hoodies (76/7d at €55) on both exit and volume this week. Balenciaga's buyer cue is the brand's designer-fashion positioning; Stone Island's is the compass badge and sportswear heritage; Off-White's is the WIP script and the Virgil Abloh streetwear narrative. Charity-shop tickets in Germany and France overlap across all three (€8–25). Condition equal and ticket equal, prefer Stone Island over Off-White because Stone Island has a higher Very Good ceiling (€45–70 vs Off-White's €40–55 band around a €42 average) and 19× the frequency. Prefer Balenciaga over both at the same ticket — Balenciaga's €70–110 Very Good band is the strongest of the three.",
          "Ralph Lauren hoodies (12/7d at €50) sit above Off-White on exit and 3× on volume. Off-White is the mid-tier streetwear-fleece play; Ralph Lauren is the polo-heritage premium fleece. They do not share a buyer. Hugo Boss hoodies (6/7d at €24) undercut Off-White on both exit and frequency — Hugo Boss is the workwear-adjacent branded-fleece slot, not streetwear. Take Off-White when the session has a Hooded Chase or Back to Black under €18 and the Stone Island rail is empty. The three brands fill different slots on the same rails; a mixed haul can list all three without competing with itself.",
          `Fred Perry hoodies (37/7d at €17) and Carhartt hoodies (7/7d at €21) are the volume and workwear comparisons, not the streetwear ones. Off-White's play is the WIP identification edge at the mid-tier: a Hooded Chase sourced at €10 targeting €48–70 is a higher per-unit return than a Fred Perry at €7 targeting €17, but Fred Perry moves 9× as often. For volume resale, Fred Perry and Stone Island are the hoodie plays. For per-transaction margin on a clean WIP piece found at the right price, Off-White Hooded Chase is the call. [Hoodie category comparison →](${ilinkHref("data")})`,
        ],
