...
export const POSTS_111: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          "Calvin Klein Hoodies: 6 departures in the last 30 days at a €14 average exit. Buy-below ceiling: €9.10. Verdict: SKIP — the demand is too thin to tie up capital. Even at €9.10, the margin is €4.90 and the item may sit for weeks. The 6 departures in the last 30 days mean roughly one sale per day across all of EU Vinted. That is not a resale market; it is a clearance channel.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "SKIP means the item does not sell enough to move reliably, the exit price is below the buy-below ceiling, or there is not enough data to make a confident call. For example, Calvin Klein Hoodies show only 6 departures in the last 30 days across all of EU Vinted at a €14 average exit — the demand is too thin to justify tying up capital.",
      },
      {
