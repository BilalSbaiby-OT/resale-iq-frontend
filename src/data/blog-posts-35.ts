...
export const POSTS_35: BlogPost[] = [
  {
    ...
    sections: [
      {
        ...
        p: [
          "The Carhartt WIP brand tracks 61 departures in the last 30 days across all categories on EU Vinted. Jackets lead at 21 departures in the last 30 days (34% of brand volume) at a €53 average — the highest exit price of any category for the brand by a significant margin. Hoodies are close in volume (20 departures in the last 30 days) but exit at €23, less than half the jacket average. T-shirts (9 departures in the last 30 days, €12 average) and shirts (5 departures in the last 30 days, €16 average) fill out the long tail.",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Patagonia exits at a €37 brand average with 178 departures in the last 30 days — higher volume but lower per-item exit price than Carhartt WIP jackets (€53). The brands have different buyer pools: Patagonia is functional/outdoor, WIP is streetwear/workwear. At charity shops, both appear with similar frequency. Carhartt WIP wins on per-jacket exit price; Patagonia wins on total weekly departure volume.",
      },
      {
