...
export const POSTS_90: BlogPost[] = [
  {
    ...
    sections: [
      {
        ...
        p: [
          "Ralph Lauren hoodies are the highest per-unit margin category in the Ralph Lauren EU Vinted dataset. Brand-level Ralph Lauren tracks 1,211 departures/30d across all categories; the hoodie segment commands the highest average exits (€45–50 for tracked models).rand's total 30-day movement — tied with shirts on volume but 64% higher on exit price (€46 vs €28). The hoodie category is characterised by genuine demand across the French, German, and Spanish Vinted markets, driven by the Ralph Lauren brand's association with American collegiate and old-money aesthetics that resonate with EU buyers aged 22–40.",
      ...
      },
      {
        ...
        p: [
          "Within the Ralph Lauren EU Vinted brand catalogue, hoodies and jackets are the two categories worth building a focused sourcing strategy around. Shirts have lower per-unit exits (30 days at €28) are structurally oversaturated — 30,000+ active listings competing for 20 weekly watched departures implies a forward supply measured in years. T-shirts (6 departures in the last 30 days at €19) have too low an exit price for meaningful gross margin after fees.",
          "Hoodies command the highest per-unit exit in the Ralph Lauren brand (€45–50 for tracked models vs €29 for shirts). At the 35% gross margin target on the Cable Knit model (22 departures/30d at €47.07), the per-unit gross is approximately €30.60.om watched departures; shirts produce €196/week. The ratio is 1.64× in favour of hoodies on a per-category basis. For a reseller managing the Ralph Lauren brand, building hoodie inventory over shirts is the mathematically correct allocation.",
          "Jackets (6 departures in the last 30 days at €56) are the highest per-unit exit in the brand but lowest 30-day volume — they are a supplementary category, not a core one. Source RL jackets opportunistically when priced below €36.40 (the buy-below at a €56 exit target), but do not structure a sourcing trip around finding them. The hoodie market at 20 departures in the last 30 days provides the volume for a repeatable sourcing operation.",
        ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes — Ralph Lauren hoodies command the highest per-unit exit in the brand. Our tracked Cable Knit model shows 22 departures/30d at €47.07 average. Brand-level Ralph Lauren tracks 1,211 departures/30d at €42.10 across all categories. €46 average, delivering a gross margin of approximately €16.10 per unit at the €29.90 buy-below ceiling. This is a 35% gross margin target, net approximately 44.6% ROI on capital deployed after platform fees. The category is superior to Ralph Lauren shirts (oversaturated at 30,000+ active listings for 20 departures in the last 30 days) and outperforms Lacoste hoodies on 30-day volume (20 vs 9 departures in the last 30 days). The key risk is condition: a pilled or cuff-stretched hoodie sourced above €12 will fall below the margin threshold. Source at €14–€26 for Very Good condition and the category generates consistent margin at a 20-unit-per-week market throughput.",
      },
      {
        q: "How do Ralph Lauren hoodies compare to Stone Island hoodies on Vinted?",
        a: "Stone Island tracks 15,663 brand-level departures in the last 30 days at €60.43 average — 13× Ralph Lauren's brand-level volume at a 44% higher average. Stone Island is the dominant premium hoodie brand on EU Vinted by a significant margin. The sourcing cost difference is equally stark: sourceable Stone Island hoodies in Very Good condition typically cost €35–€60 at European second-hand markets, compared to €14–€26 for Ralph Lauren. Ralph Lauren hoodies occupy the mid-range tier at €46 average exit — accessible sourcing cost, reliable buyer demand, and a 38% gross margin target at the buy-below ceiling. For resellers with a per-unit sourcing budget of €15–€30, Ralph Lauren is the optimal mid-range hoodie brand on EU Vinted. Stone Island targets a different budget tier and buyer segment.",
      },
    ],
  },
]
