// Batch 108 of SEO/AEO articles. Same contract as blog-posts.ts.
// Balenciaga Hoodies EU Vinted price guide — targets
// "balenciaga hoodie vinted price", "balenciaga hoodie eu vinted price guide",
// "is balenciaga hoodie worth reselling vinted", "balenciaga hoodie buy below vinted",
// "balenciaga hoodie resell value europe", "balenciaga hoodie vs stone island vinted",
// "balenciaga hoodie authentication vinted", "balenciaga padded hoodie vinted".
// DISTINCT from balenciaga-sneakers-eu-vinted-price-guide (footwear, 70/7d @€158),
// balenciaga-t-shirts-eu-vinted-price-guide (56/7d @€96), balenciaga-bag-eu-vinted-price-guide
// (46/7d @€324), and balenciaga-reselling-vinted-guide (brand overview, hoodies as one stale
// paragraph). This guide is HOODIES ONLY: 38/7d @€100 avg (19 Sep 2026 live snapshot),
// buy-below €65, streetwear luxury vs Stone Island hoodies (76/7d @€55) and Off-White hoodies
// (4/7d @€42), authentication red flags at the rack.

import type { BlogPost } from "./blog-posts"
import { pricingBodyCta, pricingMidCta } from "@/lib/blog-mid-cta"
import { ilinkHref } from "@/lib/blog-ilink"

export const POSTS_108: BlogPost[] = [
  {
    ...
    description:
      "Balenciaga hoodies track 38 watched departures per week on EU Vinted at a €100 average exit price as of 19 September 2026 — the highest-value hoodie category among the 28 brands Resale IQ tracks across 5 EU markets, and nearly double the €55 Stone Island hoodie average. Buy-below €65, padded vs unlined identification, sneaker-does-not-apply luxury authentication, and how Balenciaga hoodies compare to Stone Island, Off-White, and Nike for EU resellers.",
    date: "2026-09-19",
    category: "Sourcing",
    readMins: 7,
    ...
    intro:
      "Balenciaga hoodies track 38 watched departures per week across EU Vinted in the week to 19 September 2026 at a €100 average exit price. Hoodies are the third-highest-volume Balenciaga category this week after sneakers (70/7d at €158) and T-shirts (56/7d at €96), and they exit at the highest hoodie average of any brand Resale IQ tracks across Spain, France, Germany, Italy and Portugal — ahead of Stone Island (76/7d at €55), Off-White (4/7d at €42), Ralph Lauren (12/7d at €50), and Nike (9/7d at €17). The buy-below ceiling at €65 (€100 × 0.65) is the second-highest hoodie ceiling on the site after Balenciaga bags (€210.60). This guide covers the live margin case, padded vs unlined vs cropped identification, luxury-authentication red flags that have nothing to do with sneakers, and how Balenciaga hoodies sit against the rest of the hoodie market for EU resellers.",

    definedTerm: {
      name: "Balenciaga hoodie departure average",
      description:
        "The Balenciaga hoodie departure average is the average price at which a tracked Balenciaga hoodie listing leaves the shelf on EU Vinted — not the asking price and not retail. As of the week to 19 September 2026, Balenciaga hoodies track 38 watched departures per week across France, Germany, Spain, Italy, and Portugal at a €100 average exit price. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The broader Balenciaga brand tracks 242 watched departures per week at a €132 brand average; hoodies are 16% of that volume and exit well below sneakers (70/7d at €158) but above T-shirts (56/7d at €96). The buy-below ceiling at the €100 departure average is €65 (€100 × 0.65), targeting 35% gross margin after Vinted platform fees. ResaleIQ updates Balenciaga hoodie exit data weekly from EU Vinted departure observations across five markets.",
    },

    sections: [
      {
        h: "Balenciaga hoodies on EU Vinted: 38 watched departures per week at €100 average",
        p: [
          "Balenciaga hoodies track 38 watched departures per week across EU Vinted at a €100 average exit price in the week to 19 September 2026. That makes hoodies the third-most-active Balenciaga category this week after sneakers (70/7d at €158) and T-shirts (56/7d at €96), and the highest-priced hoodie category of any of the 28 brands Resale IQ tracks across the five EU markets. The €100 hoodie average sits €32 above the €68 Balenciaga brand average across all categories and nearly double the €55 Stone Island hoodie average — the next closest hoodie comp in the catalogue.",
          "38 departures per week at €100 average is €3,800 of observed weekly hoodie revenue across five markets. That is not a volume operation and it is not the Balenciaga money — observed sneaker revenue this week is €11,060 (70 × €158), and observed T-shirt revenue is €5,376 (56 × €96). The hoodie is the piece that turns up on a German Kleiderkammer rail, a Paris brocante, and an Italian vintage dealer's shelf, and the buyer is paying for the logo, the construction, and the seasonal cachet — not for a daily-driver fleece. A Balenciaga hoodie buyer on EU Vinted is not comparing against a Nike Club Fleece at €17. They are comparing against a Stone Island hoodie at €55 and deciding whether the triple is worth the extra €45.",
          `€100 puts Balenciaga hoodies at the top of the hoodie price ladder: ahead of Stone Island (76/7d at €55), Ralph Lauren (12/7d at €50), Hugo Boss (6/7d at €24), Off-White (4/7d at €42), Carhartt WIP (7/7d at €21), Tommy Hilfiger (8/7d at €20), and Nike (9/7d at €17). [Full hoodie category comparison →](${ilinkHref("data")})`,
        ],
        cta: pricingMidCta("ctr_balenciaga_hoodie_intro_20260919"),
      },
      {
      ...
      },
      {
        ...
        p: [
          "Yes, if the sourcing price is under €65 and the logo and construction are intact. At 38 watched departures per week and a €100 average, Balenciaga hoodies are a margin play, not a volume play. A clean padded hoodie at €30-50 at source is one of the better per-minute decisions on a European rail. A pilled unlined pullover at €55 is a skip.",
          ...
          "In a session that has both a clean Balenciaga hoodie and a clean Stone Island hoodie, the Stone Island turns faster (76/7d vs 38/7d) at roughly half the exit (€55 vs €100). The Balenciaga is the higher-ceiling piece; the Stone Island is the faster cash turn. If the source price is the same, the Stone Island is the easier flip and the Balenciaga is the bigger per-unit win on margin. Do not confuse either with Balenciaga sneakers — a Balenciaga hoodie and a Balenciaga Triple S do not share a buyer, a capital ticket, or an exit band.",
        ],
