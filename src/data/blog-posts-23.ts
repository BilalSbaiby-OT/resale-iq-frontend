    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          "**Fred Perry** → 'Fred Perrry', 'Fred Pery', 'Fredperry'. High volume brand; even a 1% misspelling rate at 850 watched departures/7d means multiple underpriced items available weekly.",
