...
// Claims honest: "30M+ listings across 5 EU markets"; no earnings promises.
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          BRAND + " gives you that number per item from " + "30M+ listings across 5 EU markets, so you can check on your phone in the aisle instead of guessing.",
        ],
      },
    ],
    faq: [
