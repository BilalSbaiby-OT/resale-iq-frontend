    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          "- **Patagonia** — 756 departures, avg €37. Jackets (313), Hoodies (128). Higher price point, strong margin per item, slower sourcing availability.",
          "- **Stone Island** — 753 departures, avg €70. Hoodies (408), Jackets (173). Highest avg price among volume leaders; fakes are a significant risk — authenticate carefully.",
          "- **Balenciaga** — 510 departures, avg €147. Sneakers (156), T-Shirts (92). High margin per item but thin sourcing opportunities and authentication risk.",
