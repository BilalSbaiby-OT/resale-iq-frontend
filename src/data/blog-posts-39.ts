...
export const POSTS_39: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          caption: "EU Vinted sneaker category comparison (week to 19 Sep 2026)",
          head: ["Brand", "Departures/7d", "Avg exit price", "Buy-below ceiling"],
          rows: [
            ["Balenciaga", "61", "€164", "€106.60"],
            ["Gucci", "9", "€211", "~€137"],
            ["New Balance", "26", "€54", "~€35"],
          ],
        },
      },
      {
    ...
    faq: [
      {
        ...
        a: "Balenciaga sneakers averaged €164 per departure across EU Vinted in the week to 19 September 2026, across 61 observed departures in France, Germany, Spain, Italy, and Portugal. Individual pairs range from around €90 for worn general-release styles to €260 or more for archive Triple S colourways in near-new condition.",
      },
      {
      ...
      },
      {
        ...
        a: "Excellent and very good condition pairs (clean or lightly yellowed soles, no upper damage) clear at the category average of €164 or above. Good-condition pairs with minor creasing or light midsole scuffing still exit, typically €20–40 below the average. Fair or worn condition pairs exit only in high-demand colourways and sizes, often at thin or zero margin at most charity-shop sourcing prices.",
      },
    ],
  },
]
