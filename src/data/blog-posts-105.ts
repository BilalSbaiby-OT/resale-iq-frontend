...
// one paragraph at stale 12/7d @€21, jackets framed as the €67 outlier) —
// this guide is HOODIES ONLY: 6/7d @€24 avg (19 Sep 2026 live snapshot),
...
// vs Tommy Hilfiger hoodies (8/7d @€20) and Carhartt (7/7d @€21).
// Jackets this week are 1/7d @€30 — not the live volume play.
...
export const POSTS_105: BlogPost[] = [
  {
    ...
    description:
      "Hugo Boss hoodies track 6 watched departures per week on EU Vinted at a €24 average exit price as of 19 September 2026 — 46% of Hugo Boss weekly volume and a different play from the 1/7d jacket market. Buy-below €15.60, BOSS vs HUGO vs BOSS Orange identification, condition grading, and how Hugo Boss hoodies compare to Tommy Hilfiger (€20) and Carhartt (€21) for EU resellers.",
    date: "2026-09-19",
    category: "Sourcing",
    readMins: 6,
    ...
    intro:
      "Hugo Boss hoodies track 6 watched departures per week across EU Vinted in the week to 19 September 2026 at a €24 average exit price. Hoodies are 46% of Hugo Boss's 13 weekly brand departures — six times the jacket count (1/7d at €30) — so the fleece rail is the Hugo Boss decision most EU charity-shop sessions actually present. The buyer is not purchasing a BOSS blazer. They are purchasing a small chest logo on midweight cotton-blend fleece: BOSS (smart-casual), HUGO (fashion-forward), or discontinued BOSS Orange. The buy-below ceiling at €15.60 (€24 × 0.65) means only clean pieces sourced under €12 deliver real margin. This guide covers the live margin case, BOSS vs HUGO vs BOSS Orange identification, buy-below by condition, and how Hugo Boss hoodies sit against Tommy Hilfiger and Carhartt for EU resellers.",

    definedTerm: {
      name: "Hugo Boss hoodie departure average",
      description:
        "The Hugo Boss hoodie departure average is the average price at which a tracked Hugo Boss hoodie listing leaves the shelf on EU Vinted — not the asking price and not retail. As of the week to 19 September 2026, Hugo Boss hoodies track 6 watched departures per week across France, Germany, Spain, Italy, and Portugal at a €24 average exit price. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The broader Hugo Boss brand tracks 13 watched departures per week at an €18 brand average; hoodies are 46% of that volume and exit above the brand average, which shirts (4/7d at €8) and tracksuits (2/7d at €15) pull down. Jackets this week are 1/7d at €30. The buy-below ceiling at the €24 departure average is €15.60 (€24 × 0.65), targeting 35% gross margin after Vinted platform fees. ResaleIQ updates Hugo Boss hoodie exit data weekly from EU Vinted departure observations across five markets.",
    },

    sections: [
      {
        h: "Hugo Boss hoodies on EU Vinted: 6 watched departures per week at €24 average",
        p: [
          "Hugo Boss hoodies track 6 watched departures per week across EU Vinted at a €24 average exit price in the week to 19 September 2026. That is the highest-volume Hugo Boss category this week: shirts 4/7d at €8, tracksuits 2/7d at €15, jackets 1/7d at €30. The €24 hoodie average sits €6 above the €18 brand average because shirts at €8 drag the brand number down. Treat the hoodie figure as its own market. A Hugo Boss hoodie buyer on EU Vinted is buying branded office-casual fleece, not a tailored jacket, and they will not pay blazer money for it.",
          "6 departures per week at €24 average is €144 of observed weekly hoodie revenue across five markets. That is not a volume operation. It is a selective add-on buy that appears on the same German and French rails as the shirts. Weekly observed shirt revenue is €32 (4 × €8) — skip the shirts. When a session has both a clean hoodie and a clean jacket, the jacket still wins on per-unit gross if it is a BOSS blazer; this week jackets barely moved (1 departure), so the live play is the hoodie.",
          `€24 puts Hugo Boss hoodies above Tommy Hilfiger hoodies (8/7d at €20), Carhartt hoodies (7/7d at €21), and Nike hoodies (9/7d at €17), and well below Ralph Lauren hoodies (12/7d at €50). The North Face hoodies (4/7d at €31) exit higher but move slower. Hugo Boss's hoodie slot is mid-price smart-casual fleece, not workwear-streetwear and not polo-heritage premium. [Full Hugo Boss brand data →](${ilinkHref("flip")})`,
        ],
      ...
      },
      {
        ...
        p: [
          "Four hoodie types drive the 6 weekly EU Vinted departures. The BOSS pullover — small tonal or contrast chest logo, midweight cotton-blend, navy / black / grey — is the piece EU smart-casual buyers search for. Very Good BOSS in those neutrals exits at €24–34, around or above the €24 category average. Size M and L move fastest on EU Vinted (office-casual fit); S and XXL lag.",
      ...
      },
      {
        ...
        p: [
          ...
          `Ralph Lauren hoodies (12/7d at €50, buy-below €32.50) are a different slot. Same weekly hoodie volume class, 2.1× the exit. A Polo hoodie sourced at €12 targeting €45–55 beats a BOSS pullover sourced at €8 targeting €24–34 on gross. If the session offers both clean, take Ralph Lauren on margin. Take Hugo Boss when Ralph Lauren is absent, which is the common German office-casual rail case. [Hoodie category comparison →](${ilinkHref("data")})`,
        ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Hugo Boss hoodies track 6 watched departures per week at €24 average; Tommy Hilfiger hoodies track 8/7d at €20 as of 19 September 2026. Tommy moves more often; Hugo Boss exits higher. The gap is the BOSS / BOSS Orange ceiling: a Very Good BOSS pullover exits at €24–34 and Orange at €30–50, above Tommy's band around the €20 average. HUGO (€18–28 Very Good) is the weaker of the two at an equal ticket. Charity-shop prices in Germany overlap. Selection rule: BOSS or Orange over Tommy at the same source price; Tommy over HUGO at the same source price. Neither matches Ralph Lauren hoodies at 12/7d and €50 average.",
      },
      {
        q: "Is a Hugo Boss hoodie worth reselling on EU Vinted?",
        a: "Yes, if it is BOSS or BOSS Orange, or a cheap clean HUGO. Hugo Boss hoodies track 6 watched departures per week at a €24 average on EU Vinted in the week to 19 September 2026. Buy-below is €15.60. Per-unit net is about €6–18 — above Tommy Hilfiger hoodies (€20 average, 8/7d) and Carhartt hoodies (€21 average, 7/7d) on exit, well below Ralph Lauren hoodies (€50 average, 12/7d), and viable when a BOSS or Orange is ticketed at €6–10 on a German rail. The identification test (BOSS / HUGO / Orange care tag, logo intact, drawcord present, cuffs not destroyed) is fast. Hugo Boss hoodies are a rack add-on, not a hunt. Take a BOSS blazer when both are clean; take the hoodie when it is Orange under €15 or BOSS under €12.",
      },
    ],
  },
]
