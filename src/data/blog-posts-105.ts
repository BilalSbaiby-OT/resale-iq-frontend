...
export const POSTS_105: BlogPost[] = [
  {
    ...
    description:
      "Hugo Boss hoodies track 6 departures in the last 30 days on EU Vinted at a €24 average exit price as of 19 September 2026 — 46% of Hugo Boss weekly volume and a different play from the 1 departures in the last 30 days jacket market. Buy-below €15.60, BOSS vs HUGO vs BOSS Orange identification, condition grading, and how Hugo Boss hoodies compare to Tommy Hilfiger (€20) and Carhartt (€21) for EU resellers.",
    date: "2026-09-19",
    category: "Sourcing",
    readMins: 6,
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          ...
          `Ralph Lauren hoodies (12 departures in the last 30 days at €50, buy-below €32.50) are a different slot. Same weekly hoodie volume class, 2.1× the exit. A Polo hoodie sourced at €12 targeting €45–55 beats a BOSS pullover sourced at €8 targeting €24–34 on gross. If the session offers both clean, take Ralph Lauren on margin. Take Hugo Boss when Ralph Lauren is absent, which is the common German office-casual rail case. [Hoodie category comparison →](${ilinkHref("data")})`,
        ],
