...
export const POSTS_38: BlogPost[] = [
  {
    ...
    description:
      "Fred Perry jackets averaged €37 per departure across EU Vinted in September 2026 — 103 jackets per week, the brand's highest-margin category. Real exit ranges, buy-below ceilings by jacket type (Harrington, track, overcoat), and how Fred Perry jackets compare to Stone Island and Patagonia for EU resellers.",
    date: "2026-09-15",
    category: "Sourcing",
    readMins: 8,
    ...
    definedTerm: {
      ...
      description:
        "The Fred Perry jacket departure average is the average price at which a tracked Fred Perry jacket listing leaves the shelf on EU Vinted — not the asking price and not the retail price. As of the week to 15 September 2026, the Fred Perry jacket departure average is €37 across 103 observed departures in France, Germany, Spain, Italy, and Portugal. This is the highest average exit price of any Fred Perry category, ahead of hoodies (€22) and polo shirts (€14). Individual exit prices range from €20 for worn or generic track jackets to €80–120 for archive Harrington styles or collaboration pieces. The buy-below ceiling at the jacket category level is €24.05.",
    },
    sections: [
      {
        h: "Fred Perry jackets on EU Vinted: the highest-margin category",
        p: [
          "Fred Perry tracks 834 watched departures per week across all categories on EU Vinted. Jackets account for 103 of those departures (12%) at a €37 average — the highest average exit price of any category in the Fred Perry range. Polo shirts move more volume (403/7d) but at €14 average; hoodies sit in the middle (131/7d at €22). The jacket category is where the per-unit margin is made.",
        ...
        cta: pricingMidCta("ctr_fp_jacket_guide_intro_20260915"),
      },
      {
      ...
      },
      {
        ...
        p: [
          ...
          "The margin structure compares favourably to Fred Perry polos. A polo sourced at €5 and exiting at €14 generates roughly €6–7 net after fees. A Harrington sourced at €12 and exiting at €42 generates roughly €25 net after fees — 3–4× the per-unit margin on similar sourcing effort per item. The limitation is sourcing frequency: Harrington jackets appear less often than polo shirts in charity shop racks, so the volume cannot match the polo pipeline.",
          "The optimal Fred Perry reselling strategy combines both categories: polo shirts for volume and capital velocity (403 departures/7d, sourcing at £3–6), Harrington jackets and track tops for per-unit margin when encountered (103 departures/7d, sourcing at €8–18). Running both in parallel maximises exposure across the brand's EU Vinted demand.",
        ],
        cta: pricingBodyCta("ctr_fp_jacket_guide_margin_20260915"),
      },
      {
