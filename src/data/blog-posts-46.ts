...
// 38 watched departures/week @ €100 avg, buy-below €65 (€100 × 0.65).
// Updated from prior POSTS_46 values (76/€105/€68.25, 15 Sept) to match current
// live snapshot. DISTINCT from balenciaga-sneakers (70/7d @€158),
// balenciaga-t-shirts (56/7d @€96), balenciaga-bag (46/7d @€324),
...
export const POSTS_46: BlogPost[] = [
  {
    ...
    intro:
      "Balenciaga hoodies track 38 watched departures per week across EU Vinted in the week to 19 September 2026 at a €100 average exit price — the highest-value hoodie category among the 28 brands Resale IQ tracks across Spain, France, Germany, Italy and Portugal, and nearly double the €55 Stone Island hoodie average. Hoodies are the third-highest-volume Balenciaga category this week after sneakers (70/7d at €158) and T-shirts (56/7d at €96), and they exit well below sneakers but above T-shirts. The buy-below ceiling at €65 (€100 × 0.65) is the second-highest hoodie ceiling on the site after Balenciaga bags (€210.60). This guide covers the live margin case, padded vs unlined vs cropped vs zip-through identification, luxury-authentication red flags that have nothing to do with sneakers, and how Balenciaga hoodies sit against Stone Island, Off-White, and Nike for EU resellers.",
