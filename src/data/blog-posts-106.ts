...
export const POSTS_106: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          "Nike hoodies track 9 departures in the last 30 days (per tracked models, model_signals, at €17 average). Tommy Hilfiger hoodies track 510 brand-level departures/30d at €19.69 avg.below on exit. Tommy's flag or small chest logo is the buyer cue; Nike's is the swoosh or the Tech Fleece knit. Charity-shop tickets in Germany overlap (€3–10). Condition equal and ticket equal, prefer a Tech Fleece Nike over a Tommy flag hoodie because Tech Fleece has a higher Very Good ceiling (€22–32 vs Tommy's band around a €20 average). Prefer Tommy over a pilled Nike Club at the same ticket — Club's €14–20 Very Good band is the weaker of the two once pilling starts.",
          "Carhartt hoodies track 7 departures in the last 30 days (per tracked models, model_signals, at €21 avg). Hugo Boss hoodies track 266 brand-level departures/30d at €16.91 avg. Both sit near Nike on exit.-day counts. A WIP Chase in Very Good condition exits at €28–42; that ceiling beats every Nike hoodie type except a clean vintage centre-swoosh. If the session offers a Chase and a Club at the same €6–8, take the Chase. Take Nike when the workwear rail is empty, which is the common sportswear-rail case.",
