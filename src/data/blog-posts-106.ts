...
// 7/7d @€37 live) and nike-sneakers-eu-vinted-price-guide (footwear) and
// nike-reselling-vinted-guide (brand overview, sneaker-dominant, hoodies as
// one stale paragraph at 23/7d @€23).
// This guide is HOODIES ONLY: 9/7d @€17 avg (19 Sep 2026 live snapshot),
...
export const POSTS_106: BlogPost[] = [
  {
    ...
    intro:
      "Nike hoodies track 9 watched departures per week across EU Vinted in the week to 19 September 2026 at a €17 average exit price. Hoodies are the second-highest-volume Nike category this week after sneakers (23/7d at €124) and ahead of jackets (7/7d at €37). They are 17% of Nike's 54 weekly brand departures. The buyer is not purchasing an Air Max. They are purchasing a Club Fleece pullover, a Tech Fleece zip, or a chest-swoosh graphic on midweight cotton. The buy-below ceiling at €11.05 (€17 × 0.65) means only clean pieces sourced under €8 deliver real margin. This guide covers the live margin case, Club Fleece vs Tech Fleece vs graphic identification, buy-below by condition, and how Nike hoodies sit against Tommy Hilfiger and Carhartt for EU resellers.",

    definedTerm: {
      name: "Nike hoodie departure average",
      description:
        "The Nike hoodie departure average is the average price at which a tracked Nike hoodie listing leaves the shelf on EU Vinted — not the asking price and not retail. As of the week to 19 September 2026, Nike hoodies track 9 watched departures per week across France, Germany, Spain, Italy, and Portugal at a €17 average exit price. 'Watched departure' means a tracked listing left the shelf — not a confirmed buyer-reported sale. The broader Nike brand tracks 54 watched departures per week at a €69 brand average; hoodies are 17% of that volume and exit well below the brand average, which sneakers (23/7d at €124) pull up. Jackets this week are 7/7d at €37. The buy-below ceiling at the €17 departure average is €11.05 (€17 × 0.65), targeting 35% gross margin after Vinted platform fees. ResaleIQ updates Nike hoodie exit data weekly from EU Vinted departure observations across five markets.",
    },

    sections: [
      {
        h: "Nike hoodies on EU Vinted: 9 watched departures per week at €17 average",
        p: [
          "Nike hoodies track 9 watched departures per week across EU Vinted at a €17 average exit price in the week to 19 September 2026. That is the highest-volume Nike apparel category this week: jackets 7/7d at €37, T-shirts 4/7d at €32, tracksuits 4/7d at €41. Sneakers still dominate the brand (23/7d at €124). The €17 hoodie average sits €52 below the €69 brand average because sneakers carry the brand number. Treat the hoodie figure as its own market. A Nike hoodie buyer on EU Vinted is buying branded fleece, not footwear, and they will not pay Air Max money for it.",
          "9 departures per week at €17 average is €153 of observed weekly hoodie revenue across five markets. That is not a volume operation and it is not the Nike money. Observed sneaker revenue this week is €2,852 (23 × €124). Observed jacket revenue is €259 (7 × €37). The hoodie is the piece that shows up on every German Kleiderkammer and French brocante rail. Weekly observed hoodie revenue only beats T-shirts (€128) because the hoodie count is higher, not because the exit is.",
          `€17 puts Nike hoodies next to Fred Perry hoodies (37/7d at €17) on price and well below Tommy Hilfiger hoodies (8/7d at €20), Carhartt hoodies (7/7d at €21), and Hugo Boss hoodies (6/7d at €24). Ralph Lauren hoodies (12/7d at €50) exit at 2.9× Nike's hoodie average. Fred Perry at the same €17 average moves four times as often; Nike wins on how often the piece is sitting on a charity-shop rail, not on clearance speed. [Full Nike brand data →](${ilinkHref("flip")})`,
        ],
      ...
      },
      {
        ...
        p: [
          "Yes, with a Tech Fleece check and a sourcing price under €8. At 9 watched departures per week and a €17 average, Nike hoodies are not a primary play. They are the fleece that shows up next to everything else. A clean Tech Fleece at €5–7 is one of the better per-minute decisions on a German or French rail. A pilled Club at €9 is a skip.",
          ...
          "In a session that has both a clean Nike hoodie and a clean Nike jacket, take the jacket. Jackets exit at €37 average (7/7d) against hoodies at €17 (9/7d). Hoodies become the buy when the jacket rail is empty or the hoodie is Tech Fleece clearly under €8. Do not confuse either with sneakers. A Nike hoodie and a Nike Air Max do not share a buyer, a capital ticket, or an exit band.",
        ],
      ...
      },
      {
        ...
        p: [
          "Nike hoodies (9/7d at €17) sit next to Tommy Hilfiger hoodies (8/7d at €20) on volume this week and €3 below on exit. Tommy's flag or small chest logo is the buyer cue; Nike's is the swoosh or the Tech Fleece knit. Charity-shop tickets in Germany overlap (€3–10). Condition equal and ticket equal, prefer a Tech Fleece Nike over a Tommy flag hoodie because Tech Fleece has a higher Very Good ceiling (€22–32 vs Tommy's band around a €20 average). Prefer Tommy over a pilled Nike Club at the same ticket — Club's €14–20 Very Good band is the weaker of the two once pilling starts.",
          "Carhartt hoodies (7/7d at €21) and Hugo Boss hoodies (6/7d at €24) sit above Nike on exit at similar weekly counts. A WIP Chase in Very Good condition exits at €28–42; that ceiling beats every Nike hoodie type except a clean vintage centre-swoosh. If the session offers a Chase and a Club at the same €6–8, take the Chase. Take Nike when the workwear rail is empty, which is the common sportswear-rail case.",
          `Fred Perry hoodies (37/7d at €17) share Nike's exit and beat it 4× on frequency. Fred Perry is the volume hoodie play at this price. Nike is the always-available filler: more donated, slower to clear, same €17 average. Ralph Lauren hoodies (12/7d at €50, buy-below €32.50) are a different slot. Same weekly hoodie volume class, 2.9× the exit. If the session offers both clean, take Ralph Lauren on margin. [Hoodie category comparison →](${ilinkHref("data")})`,
        ],
    ...
    faq: [
      {
        ...
        a: "Nike hoodies track 9 watched departures per week across EU Vinted at a €17 average exit price as of the week to 19 September 2026. By condition: Like New (no pilling, crisp branding, intact drawcord, firm cuffs) → €22–30. Very Good (light use, print intact, drawcord present) → €14–20. Good (cuff pilling, slight print fade) → €10–14. Fair (heavy pilling, cracked print, missing drawcord) → €6–10. By type: Tech Fleece hoodie in Very Good condition exits at €22–32. NSW Club Fleece pullover exits at €14–20. Club zip-through exits at €16–24. Modern chest-swoosh graphic exits at €12–18. Vintage centre-swoosh in L/XL exits at €20–35. The broader Nike brand tracks 54 watched departures per week at a €69 brand average — hoodies are 17% of that volume and exit well below sneakers (23/7d at €124) and jackets (7/7d at €37). ResaleIQ tracks Nike hoodie exit data weekly from EU Vinted departure observations across France, Germany, Spain, Italy, and Portugal.",
      },
      {
