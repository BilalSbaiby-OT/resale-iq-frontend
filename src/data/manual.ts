    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "As of 12 September 2026, across the brands we watch leave Vinted's shelf, a Fred Perry Shirt departed at an average of €14 (541 watched departures in seven days) and a Gucci Bag at €288 (97). Same sell-one-item motion at twenty times the price and roughly a fifth of the turnover, which is why a single target margin applied to both does not work.",
        ],
        callout: {
          label: "The test",
